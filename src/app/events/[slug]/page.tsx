...
import { hanumanEventsData, type HanumanEvent } from '@/data/events-data';
import { getDetailedEventById, type DetailedHanumanEvent, detailedEventsData } from '@/data/event-details-data';
...
export async function generateMetadata(
  ...
  return {
    ...
    openGraph: {
      title: `${eventTitle} | Hanuman Leela Events`,
      description: eventDescription,
                ...
                <PageHeader title={summaryEvent.title} description={summaryEvent.description} />
                 {summaryEvent.imageUrl && (
                    <div className="relative h-60 md:h-80 w-full max-w-3xl mx-auto rounded-xl overflow-hidden shadow-2xl mb-8">
                        <Image src={summaryEvent.imageUrl} alt={summaryEvent.title} fill objectFit="cover" data-ai-hint={summaryEvent.imageHint || 'event image'}/>
                    </div>
                )}
